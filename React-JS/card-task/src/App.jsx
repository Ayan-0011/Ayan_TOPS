  ...
  return (
    <>
      <div className='parents'>
        {
            data.map((data)=>{
              return <Cards  key={data.id}  logo={data.brandLogo} name={data.companyName} date={data.datePosted} post={data.post} tag1={data.tag1} tag2={data.tag2} pay={data.pay} location={data.location} />
            })
        }
      </div>
    </>
