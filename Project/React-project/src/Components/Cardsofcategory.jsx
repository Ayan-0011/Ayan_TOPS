    ...
    <div className="bg-[#101829] h-[450px]">
      ...
      <div className="max-w-7xl mx-auto flex flex-wrap gap-4 items-center justify-center py-1 px-4">
        {categoryData?.slice(0,4)?.map((item) => (
         <Link to={'/product'}> <div key={item.id} className="uppercase bg-gray-200 text-black rounded-md cursor-pointer w-[300px] h-[330px] flex items-center flex-col justify-center mb-10" >
