    ...
    <div className='space-y-4 mt-2 rounded-md'>
      <div className='bg-gray-100 flex gap-7 items-center p-2 rounded-md'>
        ...
        <div className='space-y-4'>
          ...
          <p className='font-semibold flex items-center md:text-lg text-md'>₹<span className='md:text-2xl text-2xl px-1'>{product.price.toLocaleString("en-IN")}</span>({product.discount}% off)</p>
