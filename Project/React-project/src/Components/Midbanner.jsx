...
import Cardofcategory from './Cardsofcategory'

const Midbanner = () => {
  return (
    <div className='bg-gray-100 md:pt-26 pb-5'>
      <div className='relative max-w-7xl mx-auto md:rounded-2xl pt-28 mb-15 bg-cover bg-center h-[550px] md:h-[600px] ' style={{ backgroundImage: `url(${banner})`, backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
